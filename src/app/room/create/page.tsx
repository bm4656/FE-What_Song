...
export default function CreateRoomPage() {
	return (
		<>
			<article className="flex flex-col h-full items-start gap-5">
			...
			<article className="flex flex-col relative h-full pt-32 items-start gap-5">
			...
			<article className="flex flex-col relative h-full justify-around items-start gap-5 pb-20 pt-10">
				<header className="w-full absolute my-1 top-0 h-20 flex items-center justify-center text-3xl font-bold">
					<AiOutlineLeft className="absolute left-0 top-0 w-20 h-20 p-4" />
					뮤직방 생성
				</header>
